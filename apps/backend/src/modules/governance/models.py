...
class Council(Base):
    ...
    members: Mapped[list["CouncilMember"]] = relationship(back_populates="council", cascade="all, delete-orphan")
    meetings: Mapped[list["Meeting"]] = relationship(back_populates="council", cascade="all, delete-orphan")
