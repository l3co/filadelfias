    ...
    if (isError || !content) {
        return (
            <div className="max-w-3xl mx-auto p-8 text-center">
                ...
                <Link to="/bible" className="text-indigo-600 hover:underline">Voltar para índice</Link>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-8 sm:px-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 pb-4 border-b border-gray-100 gap-4">
                <Link to="/bible" className="text-gray-500 hover:text-indigo-600 flex items-center gap-2 text-sm font-medium transition-colors">
            ...
            {/* Verses Content */}
            <div className="prose prose-lg prose-indigo mx-auto text-gray-800 leading-relaxed font-serif">
            ...
            {/* Navigation Footer */}
            <div className="flex justify-between mt-12 pt-8 border-t border-gray-100 sticky bottom-0 bg-white/95 backdrop-blur py-4 border-t-2 border-indigo-50">
                {content.previous_chapter ? (
                    <Link
                        to={`/bible/${content.previous_chapter.book}/${content.previous_chapter.chapter}`}
                        className="flex items-center gap-2 text-indigo-700 font-medium hover:bg-indigo-50 px-4 py-2 rounded-lg transition-colors"
                    >
                        <ChevronLeft size={20} />
