...
class Settings(BaseSettings):
    ...
    cors_origins_str: str = "http://localhost:3000,http://localhost:5173,http://127.0.0.1:5173,http://127.0.0.1:4173,http://localhost:4173,https://filadelfias-6a116.web.app,https://filadelfias.com,https://www.filadelfias.com,tauri://localhost,https://tauri.localhost"
