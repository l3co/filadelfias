                        ...
                        <main className="mt-10 mx-auto max-w-7xl sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28">
                            <div className="sm:text-center lg:text-left">
                                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                    ...
                                    <span className="block text-indigo-600 xl:inline">Conteúdo para sua Fé.</span>
                                </h1>
                                ...
                                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start gap-4">
                                    <div className="rounded-md shadow">
                                        <Link
                                            to="/onboarding"
                                            className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10 transition-transform hover:-translate-y-0.5"
                                        >
                                            Começar Agora
                                        </Link>
                                    </div>
                                    <div className="mt-3 sm:mt-0 sm:ml-3">
                                        <Link
                                            to="/bible"
                                            className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-indigo-700 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10 transition-transform hover:-translate-y-0.5"
                                        >
                                            Ler a Bíblia
                                        </Link>
                                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <Link to="/bible" className="bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow p-8 flex flex-col md:flex-row items-center gap-6 border border-gray-100 group">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <span className="text-blue-600 font-medium inline-flex items-center">Ler agora <ArrowRight className="ml-2 w-4 h-4" /></span>
                            </div>
                        </Link>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Para Liderança</h2>
